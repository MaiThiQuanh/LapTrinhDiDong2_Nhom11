...
import com.example.quanlybanhang.activity.ChiTietSanPham;
import com.example.quanlybanhang.model.Sanpham;
import com.example.quanlybanhang.ultil.CheckConnection;
...
public class SanphamAdapter extends RecyclerView.Adapter<SanphamAdapter.ItemHolder> {
    ...
    public class ItemHolder extends RecyclerView.ViewHolder {
        ...
        public ItemHolder(@NonNull View itemView) {
            ...
            ImageView imageViewiconmoi = (ImageView) itemView.findViewById(R.id.imageiconmoi);
            Animation animation = AnimationUtils.loadAnimation(context, R.anim.anim_blink);
            imageViewiconmoi.startAnimation(animation);
